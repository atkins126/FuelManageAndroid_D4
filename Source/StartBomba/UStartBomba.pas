...
begin
 ...
 if(vStart=1)then // finaliza bomba
 begin
...
begin
 RecImgStart.Height      := (frmStartBomba.Height/2)-95;
 RecImgStop.Height       := (frmStartBomba.Height/2)-95;
